...
def run():
	...
	yield from client.send_message('LineClaim', '40', '-alias', 'HouseLight')
	yield from client.send_message('LineClaim', '41', '-alias', 'TrayLight')
	yield from client.send_message('LineClaim', '42', '-alias', 'PelletDispenser')
	yield from client.send_message('LineClaim', '43', '-alias', 'WhiteNoise')
	...
	#Set up display 
	yield from client.send_message('DisplayClaim', '1', '-alias', 'screen')
