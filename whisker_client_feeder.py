...
# Sessions consist of x trials
# Trials consist of: tray light goes turns on 
#					after 500ms, 2 pellets drop
#					after 2s tray light goes off
#					15s ITI
import asyncio
import random
import time
...
#________________________________________________________________________________________________
	@asyncio.coroutine
	def iti(self):
		iti = random.gauss(20, 2.5)
		while iti<10 or iti>30 :   
			iti = random.gauss(20, 2.5)
			pass
		print(int(iti))
		time.sleep(iti)
...
#________________________________________________________________________________________________
	...
	def start_Expt(self):
		...
		yield from client.send_message('TimerSetEvent', '30000', '0', 'end')
