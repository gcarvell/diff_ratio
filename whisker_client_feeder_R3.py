...
def run():
	...
	yield from client.send_message('LineClaim', '48', '-alias', 'HouseLight')
	yield from client.send_message('LineClaim', '49', '-alias', 'TrayLight')
	yield from client.send_message('LineClaim', '50', '-alias', 'PelletDispenser')
	yield from client.send_message('LineClaim', '51', '-alias', 'WhiteNoise')
	...
	#Set up display 
	yield from client.send_message('DisplayClaim', '2', '-alias', 'screen')
